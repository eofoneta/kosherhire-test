...
const App = () => {
  ...
  // TO REPRESENT ACTIEV DIR
  // FIX - WHEN A CHILD NODE IS ACTIVE, DISPLAY PATHS TO THE ADDRESS BAR (INSTEAD OF REMOOVING IT'S INHERITED FOLDERS) BUT HIGHLIGHT THE ACTIVE PATH
  // IN THE ADDRESS AND THE FOLDER IT BELONGS
  // }
